...
uLongf *c;
{
    ...
    if (s->checkfn != Z_NULL) z->adler = s->check = (*s->checkfn)(0L, (const Bytef *)Z_NULL, 0);
...
int r;
{
    ...
    case STORED:
        ...
        break;
    case TABLE: NEEDBITS(14) s->sub.trees.table = t = (uInt)b & 0x3fff;
    ...
    case CODES:
        UPDATE
        if ((r = inflate_codes(s, z, r)) != Z_STREAM_END) return inflate_flush(s, z, r);
        r = Z_OK;
    ...
    case DRY:
        ...
        s->mode = DONE;
    case DONE: r = Z_STREAM_END; LEAVE
    case BAD:  r = Z_DATA_ERROR; LEAVE
    default:   r = Z_STREAM_ERROR; LEAVE
    }
}
...
void inflate_set_dictionary(s, d, n) inflate_blocks_statef *s;
const Bytef *d;
uInt n;
{
