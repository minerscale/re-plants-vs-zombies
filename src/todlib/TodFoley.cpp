...
FoleyParams gLawnFoleyParamArray[static_cast<int>(FoleyType::NUM_FOLEY)] = {
  //  0x69FAD0
    ...
    {FoleyType::FOLEY_THROW,
               10.0f,                                          {&Sexy::SOUND_THROW, &Sexy::SOUND_THROW, &Sexy::SOUND_THROW, &Sexy::SOUND_THROW2},
               0U                                                                                                                                                        },
    ...
    {FoleyType::FOLEY_GROAN,
               0.0f,                                           {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4, &Sexy::SOUND_GROAN5,
      &Sexy::SOUND_GROAN6},
               0U                                                                                                                                                        },
    {FoleyType::FOLEY_BRAINS,
               0.0f,                                           {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4, &Sexy::SOUND_GROAN5,
      &Sexy::SOUND_GROAN6, &Sexy::SOUND_SUKHBIR4, &Sexy::SOUND_SUKHBIR5, &Sexy::SOUND_SUKHBIR6},
               0U                                                                                                                                                        },
    {FoleyType::FOLEY_SUKHBIR,
               0.0f,                                           {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4, &Sexy::SOUND_GROAN5,
      &Sexy::SOUND_GROAN6, &Sexy::SOUND_SUKHBIR, &Sexy::SOUND_SUKHBIR2, &Sexy::SOUND_SUKHBIR3},
               0U                                                                                                                                                        },
    ...
    {FoleyType::FOLEY_JACK_SURPRISE,
               1.0f,                                           {&Sexy::SOUND_JACK_SURPRISE, &Sexy::SOUND_JACK_SURPRISE, &Sexy::SOUND_JACK_SURPRISE2},
               0U                                                                                                                                                        },
    ...
    {FoleyType::FOLEY_IGNITE,
               5.0f,                                           {&Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE2},
               0U                                                                                                                                                        },
    ...
    {FoleyType::FOLEY_BUNGEE_SCREAM,
               2.0f,                                           {&Sexy::SOUND_BUNGEE_SCREAM, &Sexy::SOUND_BUNGEE_SCREAM2, &Sexy::SOUND_BUNGEE_SCREAM3},
               0U                                                                                                                                                        },
    ...
    {FoleyType::FOLEY_CRAZY_DAVE_SHORT,
               0.0f,                                           {&Sexy::SOUND_CRAZYDAVESHORT1, &Sexy::SOUND_CRAZYDAVESHORT2, &Sexy::SOUND_CRAZYDAVESHORT3},
               16U                                                                                                                                                       },
    {FoleyType::FOLEY_CRAZY_DAVE_LONG,
               0.0f,                                           {&Sexy::SOUND_CRAZYDAVELONG1, &Sexy::SOUND_CRAZYDAVELONG2, &Sexy::SOUND_CRAZYDAVELONG3},
               16U                                                                                                                                                       },
    {FoleyType::FOLEY_CRAZY_DAVE_EXTRA_LONG,
               0.0f,                                           {&Sexy::SOUND_CRAZYDAVEEXTRALONG1, &Sexy::SOUND_CRAZYDAVEEXTRALONG2, &Sexy::SOUND_CRAZYDAVEEXTRALONG3},
               16U                                                                                                                                                       },
...
// 0x514ED0
FoleyTypeData::FoleyTypeData() { mLastVariationPlayed = -1; }
...
void TodFoley::PlayFoleyPitch(FoleyType theFoleyType, float thePitch) {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        {
            if (aFoleyParams->mSfxID[i] == nullptr) break;
...
void TodFoley::StopFoley(FoleyType theFoleyType) {
    ...
    FoleyInstance *aFoleyInstance = SoundSystemFindInstance(this, theFoleyType);
    if (aFoleyInstance == nullptr) return;
                ...
                if (aFoleyInstance->mRefCount != 0) // 如果音效实例存在引用
                {
                    if (theEnteringPause) {
                        ...
                        if (aFoleyInstance->mInstance->IsPlaying()) {
                            ...
                            aFoleyInstance->mInstance->Stop();
                        } else {
                            aFoleyInstance->mPauseOffset =
                                aFoleyInstance->mInstance->GetSoundPosition(); // 备份暂停时的播放进度
                            aFoleyInstance->mInstance->Stop();
                        }
                    } else if (aFoleyInstance->mPaused) {
                        ...
                        if (aFoleyInstance->mInstance->IsPlaying())
                            aFoleyInstance->mInstance->SetSoundPosition(aFoleyInstance->mPauseOffset
                            ); // 还原暂停前的播放进度
                    }
                }
            }
