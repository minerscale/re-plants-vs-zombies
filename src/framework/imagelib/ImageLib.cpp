...
ImageLib::GetImage(const std::string &theFilename, bool lookForAlphaImage, bool /*theDoImageSanding*/) {
    ...
    if ((anImage == NULL) && (stricmp(anExt.c_str(), ".j2k") == 0)) anImage = GetImageWithSDL(aFilename + ".j2k");
    if ((anImage == NULL) && (stricmp(anExt.c_str(), ".jp2") == 0)) anImage = GetImageWithSDL(aFilename + ".jp2");
