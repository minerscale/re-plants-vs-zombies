...
inline bool Ratio::operator!=(const Ratio &theRatio) const { return !(*this == theRatio); }
...
inline int Ratio::operator*(int theInt) const { return theInt * mNumerator / mDenominator; }

inline int Ratio::operator/(int theInt) const { return theInt * mDenominator / mNumerator; }
