...
public:
    ...
    //	SysFont(SexyAppBase* theApp, const std::string& theFace, int thePointSize, int theScript = ANSI_CHARSET, bool
    //bold = false, bool italics = false, bool underline = false);
