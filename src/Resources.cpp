...
void *gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] = {
    ...
    &Sexy::FONT_IMAGE_HOUSEOFTERROR28, &Sexy::FONT_HOUSEOFTERROR28, &Sexy::FONT_HOUSEOFTERROR20,
    &Sexy::FONT_HOUSEOFTERROR16, &Sexy::FONT_TINYBOLD, &Sexy::FONT_CONTINUUMBOLD14, &Sexy::FONT_CONTINUUMBOLD14OUTLINE,
    &Sexy::FONT_DWARVENTODCRAFT12, &Sexy::FONT_DWARVENTODCRAFT15, &Sexy::FONT_DWARVENTODCRAFT18,
    &Sexy::FONT_DWARVENTODCRAFT18BRIGHTGREENINSET, &Sexy::FONT_DWARVENTODCRAFT18GREENINSET,
    &Sexy::FONT_DWARVENTODCRAFT18YELLOW, &Sexy::FONT_DWARVENTODCRAFT24, &Sexy::FONT_DWARVENTODCRAFT36BRIGHTGREENINSET,
    &Sexy::FONT_DWARVENTODCRAFT36GREENINSET, &Sexy::FONT_PICO129, &Sexy::FONT_BRIANNETOD12, &Sexy::IMAGE_EDITBOX,
    &Sexy::IMAGE_DIALOG_TOPLEFT, &Sexy::IMAGE_DIALOG_TOPMIDDLE, &Sexy::IMAGE_DIALOG_TOPRIGHT,
    &Sexy::IMAGE_DIALOG_CENTERLEFT, &Sexy::IMAGE_DIALOG_CENTERMIDDLE, &Sexy::IMAGE_DIALOG_CENTERRIGHT,
    &Sexy::IMAGE_DIALOG_BOTTOMLEFT, &Sexy::IMAGE_DIALOG_BOTTOMMIDDLE, &Sexy::IMAGE_DIALOG_BOTTOMRIGHT,
    &Sexy::IMAGE_DIALOG_BIGBOTTOMLEFT, &Sexy::IMAGE_DIALOG_BIGBOTTOMMIDDLE, &Sexy::IMAGE_DIALOG_BIGBOTTOMRIGHT,
    &Sexy::IMAGE_DIALOG_HEADER, &Sexy::IMAGE_BUTTON_LEFT, &Sexy::IMAGE_BUTTON_MIDDLE, &Sexy::IMAGE_BUTTON_RIGHT,
    &Sexy::IMAGE_BUTTON_DOWN_LEFT, &Sexy::IMAGE_BUTTON_DOWN_MIDDLE, &Sexy::IMAGE_BUTTON_DOWN_RIGHT,
    &Sexy::IMAGE_SEEDCHOOSER_BACKGROUND, &Sexy::IMAGE_SEEDCHOOSER_BUTTON, &Sexy::IMAGE_SEEDCHOOSER_BUTTON_DISABLED,
    &Sexy::IMAGE_SEEDCHOOSER_BUTTON_GLOW, &Sexy::IMAGE_SEEDCHOOSER_BUTTON2, &Sexy::IMAGE_SEEDCHOOSER_BUTTON2_GLOW,
    &Sexy::IMAGE_SEEDCHOOSER_IMITATERADDON, &Sexy::IMAGE_SEEDS, &Sexy::IMAGE_SEEDPACKET_LARGER,
    &Sexy::IMAGE_SEEDPACKETSILHOUETTE, &Sexy::IMAGE_FLAGMETER, &Sexy::IMAGE_FLAGMETERLEVELPROGRESS,
    &Sexy::IMAGE_FLAGMETERPARTS, &Sexy::IMAGE_TROPHY, &Sexy::IMAGE_TROPHY_HI_RES, &Sexy::IMAGE_MINIGAME_TROPHY,
    &Sexy::IMAGE_ZOMBIE_NOTE_SMALL, &Sexy::IMAGE_TACO, &Sexy::IMAGE_CARKEYS, &Sexy::IMAGE_ALMANAC,
    &Sexy::IMAGE_ICON_POOLCLEANER, &Sexy::IMAGE_ICON_ROOFCLEANER, &Sexy::IMAGE_ICON_RAKE, &Sexy::IMAGE_BRAIN,
    &Sexy::IMAGE_MONEYBAG, &Sexy::IMAGE_MONEYBAG_HI_RES, &Sexy::IMAGE_CHOCOLATE, &Sexy::IMAGE_OPTIONS_BACKTOGAMEBUTTON0,
    &Sexy::IMAGE_OPTIONS_BACKTOGAMEBUTTON2, &Sexy::IMAGE_OPTIONS_CHECKBOX0, &Sexy::IMAGE_OPTIONS_CHECKBOX1,
    &Sexy::IMAGE_OPTIONS_MENUBACK, &Sexy::IMAGE_OPTIONS_SLIDERKNOB2, &Sexy::IMAGE_OPTIONS_SLIDERSLOT,
    &Sexy::IMAGE_SELECTORSCREEN_HELP1, &Sexy::IMAGE_SELECTORSCREEN_HELP2, &Sexy::IMAGE_SELECTORSCREEN_OPTIONS1,
    &Sexy::IMAGE_SELECTORSCREEN_OPTIONS2, &Sexy::IMAGE_SELECTORSCREEN_QUIT1, &Sexy::IMAGE_SELECTORSCREEN_QUIT2,
    &Sexy::IMAGE_SELECTORSCREEN_ALMANAC, &Sexy::IMAGE_SELECTORSCREEN_ALMANACHIGHLIGHT,
    &Sexy::IMAGE_SELECTORSCREEN_STORE, &Sexy::IMAGE_SELECTORSCREEN_STOREHIGHLIGHT,
    &Sexy::IMAGE_SELECTORSCREEN_LEVELNUMBERS, &Sexy::IMAGE_SELECTORSCREEN_ZENGARDEN,
    &Sexy::IMAGE_SELECTORSCREEN_ZENGARDENHIGHLIGHT, &Sexy::IMAGE_STORE_SPEECHBUBBLE, &Sexy::IMAGE_STORE_SPEECHBUBBLE2,
    &Sexy::IMAGE_SELECTORSCREEN_ACHIEVEMENTS_BG, &Sexy::IMAGE_SELECTORSCREEN_MOREWAYSTOPLAY_BG,
    &Sexy::IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL, &Sexy::IMAGE_SELECTORSCREEN_ACHIEVEMENTS_PEDESTAL_PRESS,
    &Sexy::IMAGE_ACHEESEMENTS_BEJEWELED, &Sexy::IMAGE_ACHEESEMENTS_BOOKWORM, &Sexy::IMAGE_ACHEESEMENTS_CHINA,
    &Sexy::IMAGE_ACHEESEMENTS_CHUZZLE, &Sexy::IMAGE_ACHEESEMENTS_HOLE_TILE, &Sexy::IMAGE_ACHEESEMENTS_PEGGLE,
    &Sexy::IMAGE_ACHEESEMENTS_PIPE, &Sexy::IMAGE_ACHEESEMENTS_ZUMA, &Sexy::IMAGE_ACHEESEMENTS_ICONS,
    &Sexy::IMAGE_ACHEESEMENTS_BACK_HIGHLIGHT, &Sexy::IMAGE_QUICKPLAY_MINIGAMES_BUTTON,
    &Sexy::IMAGE_QUICKPLAY_MINIGAMES_BUTTON_HIGHLIGHT, &Sexy::IMAGE_QUICKPLAY_MINIGAMES_CLOUD,
    &Sexy::IMAGE_QUICKPLAY_PUZZLES_BUTTON, &Sexy::IMAGE_QUICKPLAY_PUZZLES_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_QUICKPLAY_PUZZLES_CLOUD, &Sexy::IMAGE_QUICKPLAY_SURVIVAL_BUTTON,
    &Sexy::IMAGE_QUICKPLAY_SURVIVAL_BUTTON_HIGHLIGHT, &Sexy::IMAGE_QUICKPLAY_SURVIVAL_CLOUD,
    &Sexy::IMAGE_QUICKPLAY_BACK_BUTTON, &Sexy::IMAGE_QUICKPLAY_BACK_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ACHEESEMENTS_MORE_ROCK, &Sexy::IMAGE_ACHEESEMENTS_MORE_BUTTON,
    &Sexy::IMAGE_ACHEESEMENTS_MORE_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ACHEESEMENTS_TOP_BUTTON,
    &Sexy::IMAGE_ACHEESEMENTS_TOP_BUTTON_HIGHLIGHT, &Sexy::IMAGE_SHOVEL, &Sexy::IMAGE_SHOVEL_HI_RES,
    &Sexy::IMAGE_TOMBSTONES, &Sexy::IMAGE_TOMBSTONE_MOUNDS, &Sexy::IMAGE_NIGHT_GRAVE_GRAPHIC, &Sexy::IMAGE_CRATER,
    &Sexy::IMAGE_CRATER_FADING, &Sexy::IMAGE_CRATER_ROOF_CENTER, &Sexy::IMAGE_CRATER_ROOF_LEFT,
    &Sexy::IMAGE_CRATER_WATER_DAY, &Sexy::IMAGE_CRATER_WATER_NIGHT, &Sexy::IMAGE_COBCANNON_TARGET,
    &Sexy::IMAGE_COBCANNON_POPCORN, &Sexy::IMAGE_FERTILIZER, &Sexy::IMAGE_WATERINGCAN, &Sexy::IMAGE_WATERINGCANGOLD,
    &Sexy::IMAGE_PHONOGRAPH, &Sexy::IMAGE_BEGHOULED_TWIST_OVERLAY, &Sexy::IMAGE_ZEN_GOLDTOOLRETICLE,
    &Sexy::IMAGE_ZEN_GARDENGLOVE, &Sexy::IMAGE_ZEN_MONEYSIGN, &Sexy::IMAGE_ZEN_NEXTGARDEN, &Sexy::IMAGE_ZEN_WHEELBARROW,
    &Sexy::IMAGE_ZENSHOPBUTTON, &Sexy::IMAGE_ZENSHOPBUTTON_HIGHLIGHT, &Sexy::IMAGE_PRESENT, &Sexy::IMAGE_PRESENTOPEN,
    &Sexy::IMAGE_SUNFLOWER_TROPHY, &Sexy::IMAGE_SLOTMACHINE_OVERLAY, &Sexy::IMAGE_SCARY_POT, &Sexy::IMAGE_BUG_SPRAY,
    &Sexy::IMAGE_PLANTSPEECHBUBBLE, &Sexy::IMAGE_WATERDROP, &Sexy::IMAGE_TREEFOOD, &Sexy::IMAGE_PACKET_PLANTS,
    &Sexy::IMAGE_ZEN_NEED_ICONS, &Sexy::IMAGE_PROJECTILEPEA, &Sexy::IMAGE_PROJECTILESNOWPEA,
    &Sexy::IMAGE_PROJECTILECACTUS, &Sexy::IMAGE_DIRTSMALL, &Sexy::IMAGE_DIRTBIG, &Sexy::IMAGE_ROCKSMALL,
    &Sexy::IMAGE_WATERPARTICLE, &Sexy::IMAGE_WHITEWATER, &Sexy::IMAGE_WHITEWATER_SHADOW,
    &Sexy::IMAGE_MELONPULT_PARTICLES, &Sexy::IMAGE_WINTERMELON_PARTICLES, &Sexy::IMAGE_PROJECTILE_STAR,
    &Sexy::IMAGE_SEEDBANK, &Sexy::IMAGE_CONVEYORBELT_BACKDROP, &Sexy::IMAGE_CONVEYORBELT, &Sexy::IMAGE_SHOVELBANK,
    &Sexy::IMAGE_SUNBANK, &Sexy::IMAGE_COINBANK, &Sexy::IMAGE_POOL, &Sexy::IMAGE_POOL_NIGHT, &Sexy::IMAGE_POOL_BASE,
    &Sexy::IMAGE_POOL_BASE_NIGHT, &Sexy::IMAGE_POOL_SHADING, &Sexy::IMAGE_POOL_SHADING_NIGHT,
    //	&Sexy::IMAGE_POOL_CAUSTIC_EFFECT,
    &Sexy::IMAGE_PLANTSHADOW, &Sexy::IMAGE_PLANTSHADOW2, &Sexy::IMAGE_PEA_SHADOWS, &Sexy::IMAGE_WALLNUT_BOWLINGSTRIPE,
    &Sexy::IMAGE_ICE, &Sexy::IMAGE_ICE_CAP, &Sexy::IMAGE_ICE_SPARKLES, &Sexy::IMAGE_IMITATERSEED,
    &Sexy::IMAGE_ALMANAC_IMITATER, &Sexy::IMAGE_IMITATERSEEDDISABLED, &Sexy::IMAGE_ICETRAP, &Sexy::IMAGE_ICETRAP2,
    &Sexy::IMAGE_ICETRAP_PARTICLES, &Sexy::IMAGE_ZOMBIE_BOBSLED1, &Sexy::IMAGE_ZOMBIE_BOBSLED2,
    &Sexy::IMAGE_ZOMBIE_BOBSLED3, &Sexy::IMAGE_ZOMBIE_BOBSLED4, &Sexy::IMAGE_ZOMBIE_BOBSLED_INSIDE,
    &Sexy::IMAGE_BUNGEECORD, &Sexy::IMAGE_BUNGEETARGET, &Sexy::IMAGE_SPOTLIGHT, &Sexy::IMAGE_SPOTLIGHT2,
    &Sexy::IMAGE_WHITEPIXEL, &Sexy::IMAGE_ZOMBIEPOLEVAULTERHEAD, &Sexy::IMAGE_ZOMBIEFOOTBALLHEAD,
    &Sexy::IMAGE_POOLSPARKLY, &Sexy::IMAGE_WALLNUTPARTICLESSMALL, &Sexy::IMAGE_WALLNUTPARTICLESLARGE,
    &Sexy::IMAGE_PEA_SPLATS, &Sexy::IMAGE_STAR_PARTICLES, &Sexy::IMAGE_STAR_SPLATS, &Sexy::IMAGE_PEA_PARTICLES,
    &Sexy::IMAGE_SNOWPEA_SPLATS, &Sexy::IMAGE_SNOWPEA_PARTICLES, &Sexy::IMAGE_SNOWPEA_PUFF, &Sexy::IMAGE_SNOWFLAKES,
    &Sexy::IMAGE_POTATOMINE_PARTICLES, &Sexy::IMAGE_PUFFSHROOM_PUFF1, &Sexy::IMAGE_ZAMBONISMOKE,
    &Sexy::IMAGE_ZOMBIEDANCERHEAD, &Sexy::IMAGE_ZOMBIEBALLOONHEAD, &Sexy::IMAGE_ZOMBIEIMPHEAD,
    &Sexy::IMAGE_ZOMBIEDIGGERHEAD, &Sexy::IMAGE_ZOMBIEDIGGERARM, &Sexy::IMAGE_ZOMBIEDOLPHINRIDERHEAD,
    &Sexy::IMAGE_ZOMBIEPOGO, &Sexy::IMAGE_ZOMBIEBACKUPDANCERHEAD, &Sexy::IMAGE_ZOMBIEBOBSLEDHEAD,
    &Sexy::IMAGE_ZOMBIELADDERHEAD, &Sexy::IMAGE_ZOMBIEYETIHEAD, &Sexy::IMAGE_SEEDPACKETFLASH,
    &Sexy::IMAGE_ZOMBIEJACKBOXARM, &Sexy::IMAGE_IMITATERCLOUDS, &Sexy::IMAGE_IMITATERPUFFS,
    &Sexy::IMAGE_ZOMBIE_BOSS_FIREBALL_PARTICLES, &Sexy::IMAGE_ZOMBIE_BOSS_ICEBALL_PARTICLES,
    &Sexy::IMAGE_ZOMBIE_BOSS_FIREBALL_GROUNDPARTICLES, &Sexy::IMAGE_ZOMBIE_BOSS_ICEBALL_GROUNDPARTICLES,
    &Sexy::IMAGE_DOOMSHROOM_EXPLOSION_BASE, &Sexy::IMAGE_RAIN, &Sexy::IMAGE_VASE_CHUNKS, &Sexy::IMAGE_ZOMBOSS_PARTICLES,
    &Sexy::IMAGE_AWARDPICKUPGLOW, &Sexy::IMAGE_ZOMBIE_SEAWEED, &Sexy::IMAGE_PINATA, &Sexy::IMAGE_ZOMBIEFUTUREGLASSES,
    &Sexy::IMAGE_DUST_PUFFS, &Sexy::IMAGE_REANIM_WALLNUT_BODY, &Sexy::IMAGE_REANIM_WALLNUT_CRACKED1,
    &Sexy::IMAGE_REANIM_WALLNUT_CRACKED2, &Sexy::IMAGE_REANIM_TALLNUT_CRACKED1, &Sexy::IMAGE_REANIM_TALLNUT_CRACKED2,
    &Sexy::IMAGE_REANIM_PUMPKIN_DAMAGE1, &Sexy::IMAGE_REANIM_PUMPKIN_DAMAGE3, &Sexy::IMAGE_REANIM_ZOMBIE_CONE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_CONE2, &Sexy::IMAGE_REANIM_ZOMBIE_CONE3, &Sexy::IMAGE_REANIM_ZOMBIE_BUCKET1,
    &Sexy::IMAGE_REANIM_ZOMBIE_BUCKET2, &Sexy::IMAGE_REANIM_ZOMBIE_BUCKET3, &Sexy::IMAGE_REANIM_ZOMBIE_DIGGER_HARDHAT,
    &Sexy::IMAGE_REANIM_ZOMBIE_DIGGER_HARDHAT2, &Sexy::IMAGE_REANIM_ZOMBIE_DIGGER_HARDHAT3,
    &Sexy::IMAGE_REANIM_ZOMBIE_SCREENDOOR1, &Sexy::IMAGE_REANIM_ZOMBIE_SCREENDOOR2,
    &Sexy::IMAGE_REANIM_ZOMBIE_SCREENDOOR3, &Sexy::IMAGE_REANIM_ZOMBIE_FLAG1, &Sexy::IMAGE_REANIM_ZOMBIE_FLAG3,
    &Sexy::IMAGE_REANIM_ZOMBIE_OUTERARM_UPPER2, &Sexy::IMAGE_REANIM_ZOMBIE_FOOTBALL_HELMET,
    &Sexy::IMAGE_REANIM_ZOMBIE_FOOTBALL_HELMET2, &Sexy::IMAGE_REANIM_ZOMBIE_FOOTBALL_HELMET3,
    &Sexy::IMAGE_REANIM_ZOMBIE_FOOTBALL_LEFTARM_HAND, &Sexy::IMAGE_REANIM_ZOMBIE_FOOTBALL_LEFTARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_PAPER_LEFTARM_UPPER2, &Sexy::IMAGE_REANIM_ZOMBIE_PAPER_LEFTARM_LOWER,
    &Sexy::IMAGE_REANIM_ZOMBIE_PAPER_PAPER2, &Sexy::IMAGE_REANIM_ZOMBIE_PAPER_PAPER3,
    &Sexy::IMAGE_REANIM_ZOMBIE_PAPER_MADHEAD, &Sexy::IMAGE_REANIM_ZOMBIE_ZAMBONI_1_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_ZAMBONI_1_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_ZAMBONI_2_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_ZAMBONI_2_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_ZAMBONI_WHEEL_FLAT,
    &Sexy::IMAGE_REANIM_COIN_SILVER_DOLLAR, &Sexy::IMAGE_REANIM_COIN_GOLD_DOLLAR, &Sexy::IMAGE_REANIM_DIAMOND,
    &Sexy::IMAGE_REANIM_COINGLOW, &Sexy::IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_HAND,
    &Sexy::IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_UPPER2, &Sexy::IMAGE_REANIM_ZOMBIE_BACKUP_INNERARM_HAND,
    &Sexy::IMAGE_REANIM_ZOMBIE_BACKUP_OUTERARM_UPPER2, &Sexy::IMAGE_REANIM_ZOMBIE_POLEVAULTER_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_OUTERARM_HAND, &Sexy::IMAGE_REANIM_ZOMBIE_BALLOON_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_IMP_ARM1_BONE, &Sexy::IMAGE_REANIM_ZOMBIE_IMP_ARM2,
    &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_BODY1_2, &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_BODY1_3,
    &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_DUCKXING, &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_ZOMBIE,
    &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_FOOT2, &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HEAD2,
    &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_OUTERARM_LOWER2, &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HEAD2_REDEYE,
    &Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HEAD_REDEYE, &Sexy::IMAGE_REANIM_ZOMBIE_DIGGER_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_DOLPHINRIDER_OUTERARM_UPPER2, &Sexy::IMAGE_REANIM_ZOMBIE_POGO_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_POGO_STICKDAMAGE1, &Sexy::IMAGE_REANIM_ZOMBIE_POGO_STICKDAMAGE2,
    &Sexy::IMAGE_REANIM_ZOMBIE_POGO_STICK2DAMAGE1, &Sexy::IMAGE_REANIM_ZOMBIE_POGO_STICK2DAMAGE2,
    &Sexy::IMAGE_REANIM_ZOMBIE_POGO_STICKHANDS2, &Sexy::IMAGE_REANIM_ZOMBIE_BOBSLED_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOBSLED_OUTERARM_HAND, &Sexy::IMAGE_REANIM_ZOMBIE_JACKBOX_BOX,
    &Sexy::IMAGE_REANIM_ZOMBIE_JACKBOX_OUTERARM_LOWER2, &Sexy::IMAGE_REANIM_ZOMBIE_SNORKLE_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_BUNGI_HEAD_SCARED, &Sexy::IMAGE_REANIM_ZOMBIE_CATAPULT_BASKETBALL,
    &Sexy::IMAGE_REANIM_ZOMBIE_CATAPULT_POLE, &Sexy::IMAGE_REANIM_ZOMBIE_CATAPULT_POLE_DAMAGE,
    &Sexy::IMAGE_REANIM_ZOMBIE_CATAPULT_POLE_WITHBALL, &Sexy::IMAGE_REANIM_ZOMBIE_CATAPULT_POLE_DAMAGE_WITHBALL,
    &Sexy::IMAGE_REANIM_ZOMBIE_CATAPULT_SIDING_DAMAGE, &Sexy::IMAGE_REANIM_ZOMBIE_LADDER_1,
    &Sexy::IMAGE_REANIM_ZOMBIE_LADDER_1_DAMAGE1, &Sexy::IMAGE_REANIM_ZOMBIE_LADDER_1_DAMAGE2,
    &Sexy::IMAGE_REANIM_ZOMBIE_LADDER_5, &Sexy::IMAGE_REANIM_ZOMBIE_LADDER_OUTERARM_UPPER2,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_ICEBALL, &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_HEAD_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_HEAD_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_JAW_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_JAW_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_OUTERARM_HAND_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_OUTERARM_HAND_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_OUTERARM_THUMB_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_OUTERARM_THUMB_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_FOOT_DAMAGE1,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_FOOT_DAMAGE2, &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_EYEGLOW_BLUE,
    &Sexy::IMAGE_REANIM_ZOMBIE_BOSS_MOUTHGLOW_BLUE, &Sexy::IMAGE_REANIM_CABBAGEPULT_CABBAGE,
    &Sexy::IMAGE_REANIM_CORNPULT_KERNAL, &Sexy::IMAGE_REANIM_CORNPULT_BUTTER, &Sexy::IMAGE_REANIM_CORNPULT_BUTTER_SPLAT,
    &Sexy::IMAGE_REANIM_MELONPULT_MELON, &Sexy::IMAGE_REANIM_WINTERMELON_PROJECTILE,
    &Sexy::IMAGE_REANIM_ZOMBIE_DIGGER_PICKAXE, &Sexy::IMAGE_REANIM_ZOMBIE_HEAD_GROSSOUT,
    &Sexy::IMAGE_REANIM_ZOMBIE_HEAD_SUNGLASSES1, &Sexy::IMAGE_REANIM_ZOMBIE_HEAD_SUNGLASSES2,
    &Sexy::IMAGE_REANIM_ZOMBIE_HEAD_SUNGLASSES3, &Sexy::IMAGE_REANIM_ZOMBIE_HEAD_SUNGLASSES4,
    &Sexy::IMAGE_REANIM_GARLIC_BODY2, &Sexy::IMAGE_REANIM_GARLIC_BODY3, &Sexy::IMAGE_REANIM_COBCANNON_COB,
    &Sexy::IMAGE_REANIM_ZOMBIE_YETI_OUTERARM_UPPER2, &Sexy::IMAGE_REANIM_ZOMBIE_YETI_OUTERARM_HAND,
    &Sexy::IMAGE_REANIM_ZOMBIE_SNORKLE_HEAD, &Sexy::IMAGE_REANIM_SELECTORSCREEN_ADVENTURE_BUTTON,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_ADVENTURE_HIGHLIGHT, &Sexy::IMAGE_REANIM_SELECTORSCREEN_STARTADVENTURE_BUTTON,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_STARTADVENTURE_HIGHLIGHT, &Sexy::IMAGE_REANIM_SELECTORSCREEN_SURVIVAL_BUTTON,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_SURVIVAL_HIGHLIGHT, &Sexy::IMAGE_REANIM_SELECTORSCREEN_CHALLENGES_BUTTON,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_CHALLENGES_HIGHLIGHT, &Sexy::IMAGE_REANIM_SELECTORSCREEN_VASEBREAKER_BUTTON,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_VASEBREAKER_HIGHLIGHT, &Sexy::IMAGE_REANIM_SELECTORSCREEN_WOODSIGN2_PRESS,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_WOODSIGN3_PRESS, &Sexy::IMAGE_REANIM_SELECTORSCREEN_BG,
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_ALMANAC_SHADOW, &Sexy::IMAGE_REANIM_SELECTORSCREEN_KEY_SHADOW,
    &Sexy::IMAGE_REANIM_TREE_BG, &Sexy::IMAGE_REANIM_POT_TOP_DARK, &Sexy::IMAGE_REANIM_ZENGARDEN_BUGSPRAY_BOTTLE,
    &Sexy::IMAGE_REANIM_STINKY_TURN3, &Sexy::IMAGE_REANIM_CRAZYDAVE_MOUTH1, &Sexy::IMAGE_REANIM_CRAZYDAVE_MOUTH4,
    &Sexy::IMAGE_REANIM_CRAZYDAVE_MOUTH5, &Sexy::IMAGE_REANIM_CRAZYDAVE_MOUTH6, &Sexy::IMAGE_REANIM_ZOMBIE_MUSTACHE2,
    &Sexy::IMAGE_REANIM_ZOMBIE_MUSTACHE3, &Sexy::SOUND_ACHIEVEMENT, &Sexy::SOUND_AWOOGA, &Sexy::SOUND_BLEEP,
    &Sexy::SOUND_BUZZER, &Sexy::SOUND_CHOMP, &Sexy::SOUND_CHOMP2, &Sexy::SOUND_CHOMPSOFT, &Sexy::SOUND_EVILLAUGH,
    &Sexy::SOUND_FLOOP, &Sexy::SOUND_FROZEN, &Sexy::SOUND_GULP, &Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2,
    &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4, &Sexy::SOUND_GROAN5, &Sexy::SOUND_GROAN6, &Sexy::SOUND_LOSEMUSIC,
    &Sexy::SOUND_MINDCONTROLLED, &Sexy::SOUND_PAUSE, &Sexy::SOUND_PLANT, &Sexy::SOUND_PLANT2, &Sexy::SOUND_POINTS,
    &Sexy::SOUND_SEEDLIFT, &Sexy::SOUND_SIREN, &Sexy::SOUND_SLURP, &Sexy::SOUND_SPLAT, &Sexy::SOUND_SPLAT2,
    &Sexy::SOUND_SPLAT3, &Sexy::SOUND_SUKHBIR, &Sexy::SOUND_SUKHBIR2, &Sexy::SOUND_SUKHBIR3, &Sexy::SOUND_SUKHBIR4,
    &Sexy::SOUND_SUKHBIR5, &Sexy::SOUND_SUKHBIR6, &Sexy::SOUND_TAP, &Sexy::SOUND_TAP2, &Sexy::SOUND_THROW,
    &Sexy::SOUND_THROW2, &Sexy::SOUND_BLOVER, &Sexy::SOUND_WINMUSIC, &Sexy::SOUND_LAWNMOWER, &Sexy::SOUND_BOING,
    &Sexy::SOUND_JACKINTHEBOX, &Sexy::SOUND_DIAMOND, &Sexy::SOUND_DOLPHIN_APPEARS, &Sexy::SOUND_DOLPHIN_BEFORE_JUMPING,
    &Sexy::SOUND_POTATO_MINE, &Sexy::SOUND_ZAMBONI, &Sexy::SOUND_BALLOON_POP, &Sexy::SOUND_THUNDER,
    &Sexy::SOUND_ZOMBIESPLASH, &Sexy::SOUND_BOWLING, &Sexy::SOUND_BOWLINGIMPACT, &Sexy::SOUND_BOWLINGIMPACT2,
    &Sexy::SOUND_GRAVEBUSTERCHOMP, &Sexy::SOUND_GRAVEBUTTON, &Sexy::SOUND_LIMBS_POP, &Sexy::SOUND_PLANTERN,
    &Sexy::SOUND_POGO_ZOMBIE, &Sexy::SOUND_SNOW_PEA_SPARKLES, &Sexy::SOUND_PLANT_WATER,
    &Sexy::SOUND_ZOMBIE_ENTERING_WATER, &Sexy::SOUND_ZOMBIE_FALLING_1, &Sexy::SOUND_ZOMBIE_FALLING_2, &Sexy::SOUND_PUFF,
    &Sexy::SOUND_FUME, &Sexy::SOUND_HUGE_WAVE, &Sexy::SOUND_SLOT_MACHINE, &Sexy::SOUND_COIN, &Sexy::SOUND_ROLL_IN,
    &Sexy::SOUND_DIGGER_ZOMBIE, &Sexy::SOUND_HATCHBACK_CLOSE, &Sexy::SOUND_HATCHBACK_OPEN, &Sexy::SOUND_KERNELPULT,
    &Sexy::SOUND_KERNELPULT2, &Sexy::SOUND_ZOMBAQUARIUM_DIE, &Sexy::SOUND_BUNGEE_SCREAM, &Sexy::SOUND_BUNGEE_SCREAM2,
    &Sexy::SOUND_BUNGEE_SCREAM3, &Sexy::SOUND_BUTTER, &Sexy::SOUND_JACK_SURPRISE, &Sexy::SOUND_JACK_SURPRISE2,
    &Sexy::SOUND_NEWSPAPER_RARRGH, &Sexy::SOUND_NEWSPAPER_RARRGH2, &Sexy::SOUND_NEWSPAPER_RIP, &Sexy::SOUND_SQUASH_HMM,
    &Sexy::SOUND_SQUASH_HMM2, &Sexy::SOUND_VASE_BREAKING, &Sexy::SOUND_POOL_CLEANER, &Sexy::SOUND_MAGNETSHROOM,
    &Sexy::SOUND_LADDER_ZOMBIE, &Sexy::SOUND_GARGANTUAR_THUMP, &Sexy::SOUND_BASKETBALL, &Sexy::SOUND_FIREPEA,
    &Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE2, &Sexy::SOUND_READYSETPLANT, &Sexy::SOUND_DOOMSHROOM,
    &Sexy::SOUND_EXPLOSION, &Sexy::SOUND_FINALWAVE, &Sexy::SOUND_REVERSE_EXPLOSION, &Sexy::SOUND_RVTHROW,
    &Sexy::SOUND_SHIELDHIT, &Sexy::SOUND_SHIELDHIT2, &Sexy::SOUND_BOSSEXPLOSION, &Sexy::SOUND_CHERRYBOMB,
    &Sexy::SOUND_BONK, &Sexy::SOUND_SWING, &Sexy::SOUND_RAIN, &Sexy::SOUND_LIGHTFILL, &Sexy::SOUND_PLASTICHIT,
    &Sexy::SOUND_PLASTICHIT2, &Sexy::SOUND_JALAPENO, &Sexy::SOUND_BALLOONINFLATE, &Sexy::SOUND_BIGCHOMP,
    &Sexy::SOUND_MELONIMPACT, &Sexy::SOUND_MELONIMPACT2, &Sexy::SOUND_PLANTGROW, &Sexy::SOUND_SHOOP,
    &Sexy::SOUND_TAPGLASS, &Sexy::SOUND_JUICY, &Sexy::SOUND_COFFEE, &Sexy::SOUND_WAKEUP, &Sexy::SOUND_LOWGROAN,
    &Sexy::SOUND_LOWGROAN2, &Sexy::SOUND_PRIZE, &Sexy::SOUND_YUCK, &Sexy::SOUND_YUCK2, &Sexy::SOUND_GRASSSTEP,
    &Sexy::SOUND_SHOVEL, &Sexy::SOUND_COBLAUNCH, &Sexy::SOUND_WATERING, &Sexy::SOUND_POLEVAULT,
    &Sexy::SOUND_GRAVESTONE_RUMBLE, &Sexy::SOUND_DIRT_RISE, &Sexy::SOUND_FERTILIZER, &Sexy::SOUND_PORTAL,
    &Sexy::SOUND_BUGSPRAY, &Sexy::SOUND_SCREAM, &Sexy::SOUND_PAPER, &Sexy::SOUND_MONEYFALLS, &Sexy::SOUND_IMP,
    &Sexy::SOUND_IMP2, &Sexy::SOUND_HYDRAULIC_SHORT, &Sexy::SOUND_HYDRAULIC, &Sexy::SOUND_GARGANTUDEATH,
    &Sexy::SOUND_CERAMIC, &Sexy::SOUND_BOSSBOULDERATTACK, &Sexy::SOUND_CHIME, &Sexy::SOUND_CRAZYDAVESHORT1,
    &Sexy::SOUND_CRAZYDAVESHORT2, &Sexy::SOUND_CRAZYDAVESHORT3, &Sexy::SOUND_CRAZYDAVELONG1,
    &Sexy::SOUND_CRAZYDAVELONG2, &Sexy::SOUND_CRAZYDAVELONG3, &Sexy::SOUND_CRAZYDAVEEXTRALONG1,
    &Sexy::SOUND_CRAZYDAVEEXTRALONG2, &Sexy::SOUND_CRAZYDAVEEXTRALONG3, &Sexy::SOUND_CRAZYDAVECRAZY,
    &Sexy::SOUND_PHONOGRAPH, &Sexy::SOUND_DANCER, &Sexy::SOUND_FINALFANFARE, &Sexy::SOUND_CRAZYDAVESCREAM,
    &Sexy::SOUND_CRAZYDAVESCREAM2, &Sexy::IMAGE_BACKGROUND1, &Sexy::IMAGE_BACKGROUND1_GAMEOVER_INTERIOR_OVERLAY,
    &Sexy::IMAGE_BACKGROUND1_GAMEOVER_MASK, &Sexy::IMAGE_BACKGROUND1UNSODDED, &Sexy::IMAGE_SOD1ROW,
    &Sexy::IMAGE_SOD3ROW, &Sexy::IMAGE_BACKGROUND2, &Sexy::IMAGE_BACKGROUND2_GAMEOVER_INTERIOR_OVERLAY,
    &Sexy::IMAGE_BACKGROUND2_GAMEOVER_MASK, &Sexy::IMAGE_BACKGROUND3,
    &Sexy::IMAGE_BACKGROUND3_GAMEOVER_INTERIOR_OVERLAY, &Sexy::IMAGE_BACKGROUND3_GAMEOVER_MASK,
    &Sexy::IMAGE_BACKGROUND4, &Sexy::IMAGE_BACKGROUND4_GAMEOVER_INTERIOR_OVERLAY,
    &Sexy::IMAGE_BACKGROUND4_GAMEOVER_MASK, &Sexy::IMAGE_FOG, &Sexy::IMAGE_FOG_SOFTWARE, &Sexy::IMAGE_BACKGROUND5,
    &Sexy::IMAGE_BACKGROUND5_GAMEOVER_MASK, &Sexy::IMAGE_BACKGROUND6BOSS, &Sexy::IMAGE_BACKGROUND6_GAMEOVER_MASK,
    &Sexy::IMAGE_BACKGROUND_MUSHROOMGARDEN, &Sexy::IMAGE_BACKGROUND_GREENHOUSE,
    &Sexy::IMAGE_BACKGROUND_GREENHOUSE_OVERLAY, &Sexy::IMAGE_AQUARIUM1, &Sexy::IMAGE_WAVECENTER, &Sexy::IMAGE_WAVESIDE,
    &Sexy::IMAGE_AWARDSCREEN_BACK, &Sexy::IMAGE_CHALLENGE_BACKGROUND, &Sexy::IMAGE_CHALLENGE_WINDOW,
    &Sexy::IMAGE_CHALLENGE_WINDOW_HIGHLIGHT, &Sexy::IMAGE_CHALLENGE_BLANK, &Sexy::IMAGE_CHALLENGE_THUMBNAILS,
    &Sexy::IMAGE_SURVIVAL_THUMBNAILS, &Sexy::IMAGE_LOCK, &Sexy::IMAGE_LOCK_OPEN, &Sexy::IMAGE_ALMANAC_INDEXBACK,
    &Sexy::IMAGE_ALMANAC_PLANTBACK, &Sexy::IMAGE_ALMANAC_ZOMBIEBACK, &Sexy::IMAGE_ALMANAC_PLANTCARD,
    &Sexy::IMAGE_ALMANAC_ZOMBIECARD, &Sexy::IMAGE_ALMANAC_ZOMBIEWINDOW, &Sexy::IMAGE_ALMANAC_ZOMBIEWINDOW2,
    &Sexy::IMAGE_ALMANAC_ZOMBIEBLANK, &Sexy::IMAGE_ALMANAC_GROUNDDAY, &Sexy::IMAGE_ALMANAC_GROUNDNIGHT,
    &Sexy::IMAGE_ALMANAC_GROUNDPOOL, &Sexy::IMAGE_ALMANAC_GROUNDNIGHTPOOL, &Sexy::IMAGE_ALMANAC_GROUNDROOF,
    &Sexy::IMAGE_ALMANAC_GROUNDICE, &Sexy::IMAGE_ALMANAC_CLOSEBUTTON, &Sexy::IMAGE_ALMANAC_CLOSEBUTTONHIGHLIGHT,
    &Sexy::IMAGE_ALMANAC_INDEXBUTTON, &Sexy::IMAGE_ALMANAC_INDEXBUTTONHIGHLIGHT, &Sexy::IMAGE_STORE_BACKGROUND,
    &Sexy::IMAGE_STORE_BACKGROUNDNIGHT, &Sexy::IMAGE_STORE_CAR, &Sexy::IMAGE_STORE_CAR_NIGHT,
    &Sexy::IMAGE_STORE_CARCLOSED, &Sexy::IMAGE_STORE_CARCLOSED_NIGHT, &Sexy::IMAGE_STORE_HATCHBACKOPEN,
    &Sexy::IMAGE_STORE_SIGN, &Sexy::IMAGE_STORE_MAINMENUBUTTON, &Sexy::IMAGE_STORE_MAINMENUBUTTONDOWN,
    &Sexy::IMAGE_STORE_MAINMENUBUTTONHIGHLIGHT, &Sexy::IMAGE_STORE_NEXTBUTTON, &Sexy::IMAGE_STORE_NEXTBUTTONHIGHLIGHT,
    &Sexy::IMAGE_STORE_NEXTBUTTONDISABLED, &Sexy::IMAGE_STORE_PREVBUTTON, &Sexy::IMAGE_STORE_PREVBUTTONHIGHLIGHT,
    &Sexy::IMAGE_STORE_PREVBUTTONDISABLED, &Sexy::IMAGE_STORE_PRICETAG, &Sexy::IMAGE_STORE_PACKETUPGRADE,
    &Sexy::IMAGE_STORE_MUSHROOMGARDENICON, &Sexy::IMAGE_STORE_AQUARIUMGARDENICON, &Sexy::IMAGE_STORE_TREEOFWISDOMICON,
    &Sexy::IMAGE_STORE_FIRSTAIDWALLNUTICON, &Sexy::IMAGE_STORE_PVZICON, &Sexy::IMAGE_ZOMBIE_NOTE,
    &Sexy::IMAGE_ZOMBIE_NOTE1, &Sexy::IMAGE_ZOMBIE_NOTE2, &Sexy::IMAGE_ZOMBIE_NOTE3, &Sexy::IMAGE_ZOMBIE_NOTE4,
    &Sexy::IMAGE_ZOMBIE_FINAL_NOTE, &Sexy::IMAGE_ZOMBIE_NOTE_HELP, &Sexy::FONT_BRIANNETOD32,
    &Sexy::FONT_BRIANNETOD32BLACK, &Sexy::IMAGE_REANIM_SUNFLOWER_HEAD_SING1, &Sexy::IMAGE_REANIM_SUNFLOWER_HEAD_SING2,
    &Sexy::IMAGE_REANIM_SUNFLOWER_HEAD_SING3, &Sexy::IMAGE_REANIM_SUNFLOWER_HEAD_SING4,
    &Sexy::IMAGE_REANIM_SUNFLOWER_HEAD_SING5, &Sexy::IMAGE_REANIM_SUNFLOWER_HEAD_WINK,
    &Sexy::IMAGE_REANIM_CREDITS_DISCOLIGHTS, &Sexy::IMAGE_REANIM_CREDITS_FOGMACHINE, &Sexy::IMAGE_CREDITS_ZOMBIENOTE,
    &Sexy::IMAGE_CREDITS_PLAYBUTTON, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG, &Sexy::IMAGE_ZOMBATAR_PREV_BUTTON,
    &Sexy::IMAGE_ZOMBATAR_PREV_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_NEXT_BUTTON,
    &Sexy::IMAGE_ZOMBATAR_NEXT_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_ZOMBIE_BLANK,
    &Sexy::IMAGE_ZOMBATAR_ZOMBIE_BLANK_SKIN, &Sexy::IMAGE_ZOMBATAR_BACKGROUND_CRAZYDAVE,
    &Sexy::IMAGE_ZOMBATAR_BACKGROUND_MENU, &Sexy::IMAGE_ZOMBATAR_BACKGROUND_MENU_DOS,
    &Sexy::IMAGE_ZOMBATAR_BACKGROUND_ROOF, &Sexy::IMAGE_ZOMBATAR_WIDGET_BG, &Sexy::IMAGE_ZOMBATAR_WIDGET_INNER_BG,
    &Sexy::IMAGE_ZOMBATAR_COLORS_BG, &Sexy::IMAGE_ZOMBATAR_LOGO, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_BUTTON,
    &Sexy::IMAGE_ZOMBATAR_ACCESSORY_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_BUTTON_OVER,
    &Sexy::IMAGE_ZOMBATAR_BACKDROPS_BUTTON, &Sexy::IMAGE_ZOMBATAR_BACKDROPS_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_BACKDROPS_BUTTON_OVER, &Sexy::IMAGE_ZOMBATAR_CLOTHES_BUTTON,
    &Sexy::IMAGE_ZOMBATAR_CLOTHES_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_CLOTHES_BUTTON_OVER,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_BUTTON, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_BUTTON_OVER, &Sexy::IMAGE_ZOMBATAR_FACIAL_HAIR_BUTTON,
    &Sexy::IMAGE_ZOMBATAR_FACIAL_HAIR_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_FACIAL_HAIR_BUTTON_OVER,
    &Sexy::IMAGE_ZOMBATAR_HAIR_BUTTON, &Sexy::IMAGE_ZOMBATAR_HAIR_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_HAIR_BUTTON_OVER, &Sexy::IMAGE_ZOMBATAR_HATS_BUTTON,
    &Sexy::IMAGE_ZOMBATAR_HATS_BUTTON_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_HATS_BUTTON_OVER,
    &Sexy::IMAGE_ZOMBATAR_SKIN_BUTTON, &Sexy::IMAGE_ZOMBATAR_SKIN_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_BUTTON, &Sexy::IMAGE_ZOMBATAR_TIDBITS_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_BUTTON_OVER, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_TRIPTYCH, &Sexy::IMAGE_ZOMBATAR_COLORPICKER, &Sexy::IMAGE_ZOMBATAR_COLORPICKER_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_COLORPICKER_NONE, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG_NONE,
    &Sexy::IMAGE_ZOMBATAR_COLORS_BG_SMALL, &Sexy::IMAGE_ZOMBATAR_CLOTHES_1, &Sexy::IMAGE_ZOMBATAR_CLOTHES_2,
    &Sexy::IMAGE_ZOMBATAR_CLOTHES_3, &Sexy::IMAGE_ZOMBATAR_CLOTHES_4, &Sexy::IMAGE_ZOMBATAR_CLOTHES_5,
    &Sexy::IMAGE_ZOMBATAR_CLOTHES_6, &Sexy::IMAGE_ZOMBATAR_CLOTHES_7, &Sexy::IMAGE_ZOMBATAR_CLOTHES_8,
    &Sexy::IMAGE_ZOMBATAR_CLOTHES_9, &Sexy::IMAGE_ZOMBATAR_CLOTHES_10, &Sexy::IMAGE_ZOMBATAR_CLOTHES_11,
    &Sexy::IMAGE_ZOMBATAR_CLOTHES_12, &Sexy::IMAGE_ZOMBATAR_HATS_1, &Sexy::IMAGE_ZOMBATAR_HATS_2,
    &Sexy::IMAGE_ZOMBATAR_HATS_3, &Sexy::IMAGE_ZOMBATAR_HATS_4, &Sexy::IMAGE_ZOMBATAR_HATS_5,
    &Sexy::IMAGE_ZOMBATAR_HATS_6, &Sexy::IMAGE_ZOMBATAR_HATS_7, &Sexy::IMAGE_ZOMBATAR_HATS_8,
    &Sexy::IMAGE_ZOMBATAR_HATS_9, &Sexy::IMAGE_ZOMBATAR_HATS_10, &Sexy::IMAGE_ZOMBATAR_HATS_11,
    &Sexy::IMAGE_ZOMBATAR_HATS_12, &Sexy::IMAGE_ZOMBATAR_HATS_13, &Sexy::IMAGE_ZOMBATAR_HATS_14,
    &Sexy::IMAGE_ZOMBATAR_HAIR_1, &Sexy::IMAGE_ZOMBATAR_HAIR_2, &Sexy::IMAGE_ZOMBATAR_HAIR_3,
    &Sexy::IMAGE_ZOMBATAR_HAIR_4, &Sexy::IMAGE_ZOMBATAR_HAIR_5, &Sexy::IMAGE_ZOMBATAR_HAIR_6,
    &Sexy::IMAGE_ZOMBATAR_HAIR_7, &Sexy::IMAGE_ZOMBATAR_HAIR_8, &Sexy::IMAGE_ZOMBATAR_HAIR_9,
    &Sexy::IMAGE_ZOMBATAR_HAIR_10, &Sexy::IMAGE_ZOMBATAR_HAIR_11, &Sexy::IMAGE_ZOMBATAR_HAIR_12,
    &Sexy::IMAGE_ZOMBATAR_HAIR_13, &Sexy::IMAGE_ZOMBATAR_HAIR_14, &Sexy::IMAGE_ZOMBATAR_HAIR_15,
    &Sexy::IMAGE_ZOMBATAR_HAIR_16, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_1, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_2,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_3, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_4, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_5,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_6, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_7, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_8,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_9, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_10, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_11,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_12, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_13, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_14,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_15, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_16, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_1,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_2, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_3, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_4,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_5, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_6, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_7,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_8, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_9, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_10,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_11, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_12, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_13,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_14, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_15, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_16,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_17, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_18, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_19,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_20, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_21, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_22,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_23, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_24, &Sexy::IMAGE_ZOMBATAR_TIDBITS_1,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_2, &Sexy::IMAGE_ZOMBATAR_TIDBITS_3, &Sexy::IMAGE_ZOMBATAR_TIDBITS_4,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_5, &Sexy::IMAGE_ZOMBATAR_TIDBITS_6, &Sexy::IMAGE_ZOMBATAR_TIDBITS_7,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_8, &Sexy::IMAGE_ZOMBATAR_TIDBITS_9, &Sexy::IMAGE_ZOMBATAR_TIDBITS_10,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_11, &Sexy::IMAGE_ZOMBATAR_TIDBITS_12, &Sexy::IMAGE_ZOMBATAR_TIDBITS_13,
    &Sexy::IMAGE_ZOMBATAR_TIDBITS_14, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_1, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_2,
    &Sexy::IMAGE_ZOMBATAR_ACCESSORY_3, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_4, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_5,
    &Sexy::IMAGE_ZOMBATAR_ACCESSORY_6, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_7, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_8,
    &Sexy::IMAGE_ZOMBATAR_ACCESSORY_9, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_10, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_11,
    &Sexy::IMAGE_ZOMBATAR_ACCESSORY_12, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_13, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_14,
    &Sexy::IMAGE_ZOMBATAR_HATS_1_MASK, &Sexy::IMAGE_ZOMBATAR_HAIR_1_MASK, &Sexy::IMAGE_ZOMBATAR_HAIR_2_MASK,
    &Sexy::IMAGE_ZOMBATAR_HAIR_11_MASK, &Sexy::IMAGE_ZOMBATAR_HAIR_12_MASK, &Sexy::IMAGE_ZOMBATAR_HAIR_13_MASK,
    &Sexy::IMAGE_ZOMBATAR_HAIR_14_MASK, &Sexy::IMAGE_ZOMBATAR_HAIR_15_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_1_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_4_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_8_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_9_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_10_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_11_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_12_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_14_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_15_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_16_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_18_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_21_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_22_MASK,
    &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_23_MASK, &Sexy::IMAGE_ZOMBATAR_FACIALHAIR_24_MASK,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_1_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_2_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_3_MASK,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_4_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_5_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_6_MASK,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_7_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_8_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_9_MASK,
    &Sexy::IMAGE_ZOMBATAR_EYEWEAR_10_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_11_MASK, &Sexy::IMAGE_ZOMBATAR_EYEWEAR_12_MASK,
    &Sexy::IMAGE_ZOMBATAR_HATS_3_MASK, &Sexy::IMAGE_ZOMBATAR_HATS_6_MASK, &Sexy::IMAGE_ZOMBATAR_HATS_7_MASK,
    &Sexy::IMAGE_ZOMBATAR_HATS_8_MASK, &Sexy::IMAGE_ZOMBATAR_HATS_9_MASK, &Sexy::IMAGE_ZOMBATAR_HATS_11_MASK,
    &Sexy::IMAGE_ZOMBATAR_BACKGROUND_BLANK, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_15, &Sexy::IMAGE_ZOMBATAR_ACCESSORY_16,
    &Sexy::IMAGE_ZOMBATAR_ACCEPT_BUTTON, &Sexy::IMAGE_ZOMBATAR_ACCEPT_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_FINISHED_BUTTON, &Sexy::IMAGE_ZOMBATAR_FINISHED_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_MAIN_BG, &Sexy::IMAGE_ZOMBATAR_BACK_BUTTON, &Sexy::IMAGE_ZOMBATAR_BACK_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_NEWZOMBIE_BUTTON, &Sexy::IMAGE_ZOMBATAR_NEWZOMBIE_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_TOS_ARROW, &Sexy::IMAGE_ZOMBATAR_BEGIN_BUTTON, &Sexy::IMAGE_ZOMBATAR_BEGIN_BUTTON_HIGHLIGHT,
    &Sexy::IMAGE_ZOMBATAR_TOS_SLIDER, &Sexy::IMAGE_ZOMBATAR_TOS_SLIDER_THUMB, &Sexy::IMAGE_ZOMBATAR_DISPLAY_WINDOW,
    &Sexy::IMAGE_ZOMBATAR_MAINMENUBACK_HIGHLIGHT, &Sexy::IMAGE_ZOMBATAR_VIEW_BUTTON,
