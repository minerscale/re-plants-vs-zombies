...
// 0x51C470
TypingCheck::TypingCheck(const std::string &thePhrase) { SetPhrase(thePhrase); }
...
void TypingCheck::AddKeyCode(Sexy::KeyCode theKeyCode) { mPhrase.append(1, static_cast<char>(theKeyCode)); }
