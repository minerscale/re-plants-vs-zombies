...
void MessageWidget::SetLabel(const SexyString &theNewLabel, MessageStyle theMessageStyle) {
    ...
    if (mReanimType != ReanimationType::REANIM_NONE && mDuration > 0) {
        ...
        case MessageStyle::MESSAGE_STYLE_HINT_TALL_LONG:  mDuration = 1500; break;

        case MessageStyle::MESSAGE_STYLE_HINT_TALL_UNLOCKMESSAGE: mDuration = 500; break;
        ...
        case MessageStyle::MESSAGE_STYLE_TUTORIAL_LATER:  mDuration = 500; break;

        case MessageStyle::MESSAGE_STYLE_HINT_STAY:
        case MessageStyle::MESSAGE_STYLE_TUTORIAL_LEVEL1_STAY:
        case MessageStyle::MESSAGE_STYLE_TUTORIAL_LATER_STAY:  mDuration = 10000; break;

        case MessageStyle::MESSAGE_STYLE_HOUSE_NAME: mDuration = 250; break;
...
_Font *MessageWidget::GetFont() {
    ...
    case MessageStyle::MESSAGE_STYLE_OFF:          break;
    }
...
void MessageWidget::Draw(Graphics *g) {
    ...
    if (mReanimType != ReanimationType::REANIM_NONE) {
        ...
        if (mMessageStyle == MessageStyle::MESSAGE_STYLE_HOUSE_NAME) {
            ...
            if (aSubStr.size() > 0) {
                TodDrawString(
                    g, aSubStr, BOARD_WIDTH / 2 - mApp->mBoard->mX, aPosY + 26, Sexy::FONT_HOUSEOFTERROR16,
