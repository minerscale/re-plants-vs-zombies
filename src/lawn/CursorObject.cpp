...
void CursorObject::Draw(Graphics *g) {
    ...
    case CursorType::CURSOR_TYPE_FERTILIZER: g->DrawImage(IMAGE_FERTILIZER, -15, 0); break;

    case CursorType::CURSOR_TYPE_BUG_SPRAY: g->DrawImage(IMAGE_BUG_SPRAY, -9, -1); break;

    case CursorType::CURSOR_TYPE_PHONOGRAPH: g->DrawImage(IMAGE_PHONOGRAPH, -17, 10); break;

    case CursorType::CURSOR_TYPE_CHOCOLATE: g->DrawImage(IMAGE_CHOCOLATE, -2, -8); break;

    case CursorType::CURSOR_TYPE_GLOVE: g->DrawImage(IMAGE_ZEN_GARDENGLOVE, -17, 15); break;

    case CursorType::CURSOR_TYPE_MONEY_SIGN: g->DrawImage(IMAGE_ZEN_MONEYSIGN, -17, -10); break;

    case CursorType::CURSOR_TYPE_TREE_FOOD: g->DrawImage(IMAGE_TREEFOOD, -15, 0); break;
    ...
    case CursorType::CURSOR_TYPE_HAMMER: mApp->ReanimationGet(mReanimCursorID)->Draw(g); break;
    ...
    case CursorType::CURSOR_TYPE_NORMAL: break;
    }
}
...
void CursorPreview::Draw(Graphics *g) {
    ...
    if (aPottedPlant) {
        ...
        Plant::DrawSeedType(
            g, mBoard->mCursorObject->mType, mBoard->mCursorObject->mImitaterType, DrawVariation::VARIATION_NORMAL,
            aOffsetX, aOffsetY
        );
    }
