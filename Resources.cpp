...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager) {
    ...
    try {
        ...
        IMAGE_REANIM_ZOMBIE_BACKUP_INNERARM_HAND =
            aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_BACKUP_INNERARM_HAND"); // @Patoke: GOTY assets have different name
        ...
        IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_HAND =
            aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_HAND"); // @Patoke: GOTY assets have different name
        IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_UPPER2 =
            aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_DISCO_OUTERARM_UPPER2"); // @Patoke: GOTY assets have different name
...
void *gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] = {
    ...
    &Sexy::IMAGE_REANIM_SELECTORSCREEN_WOODSIGN3_PRESS, // @Patoke: added these
