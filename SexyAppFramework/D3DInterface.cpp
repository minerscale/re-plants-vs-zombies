        ...
        for (int aTriangleNum = 0; aTriangleNum < theNumTriangles; aTriangleNum++) {
            ...
            D3DTLVERTEX aVertex[3] = {
                {{aTriVerts[0].x + tx},
                 ...
                 {0},
                 {1},
                 {GetColorFromTriVertex(aTriVerts[0], theColor)},
                 {0},
                ...
                {{aTriVerts[1].x + tx},
                 ...
                 {0},
                 {1},
                 {GetColorFromTriVertex(aTriVerts[1], theColor)},
                 {0},
                ...
                {{aTriVerts[2].x + tx},
                 ...
                 {0},
                 {1},
                 {GetColorFromTriVertex(aTriVerts[2], theColor)},
                 {0},
...
void D3DInterface::FillPoly(
    ...
    for (int i = 0; i < theNumVertices; i++) {
        D3DTLVERTEX vert = {
            {theVertices[i].mX + (D3DVALUE)tx}, {theVertices[i].mY + (D3DVALUE)ty}, {0}, {1}, {aColor}, {0}, {0}, {0}
        };
        if (!mTransformStack.empty()) {
