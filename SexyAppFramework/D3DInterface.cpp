...
static void DisplayError(HRESULT theError, const char *theMsg) {
    ...
    if (!hadError) {
        ...
        if (aResult == IDABORT) exit(0);
        else if (aResult == IDRETRY) _asm int 3;
    }
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
D3DInterface::~D3DInterface() { Cleanup(); }
...
PixelFormat D3DInterface::GetDDPixelFormat(LPDDPIXELFORMAT theFormat) {
    if (theFormat->dwFlags == (DDPF_ALPHAPIXELS | DDPF_RGB) && theFormat->dwRGBBitCount == 32 &&
        theFormat->dwRGBAlphaBitMask == 0xFF000000 && theFormat->dwRBitMask == 0x00FF0000 &&
        theFormat->dwGBitMask == 0x0000FF00 && theFormat->dwBBitMask == 0x000000FF) {
        return PixelFormat_A8R8G8B8;
    }

    if (theFormat->dwFlags == (DDPF_ALPHAPIXELS | DDPF_RGB) && theFormat->dwRGBBitCount == 16 &&
        theFormat->dwRGBAlphaBitMask == 0xF000 && theFormat->dwRBitMask == 0x0F00 && theFormat->dwGBitMask == 0x00F0 &&
        theFormat->dwBBitMask == 0x000F) {
        return PixelFormat_A4R4G4B4;
    }

    if (theFormat->dwFlags == DDPF_RGB && theFormat->dwRGBBitCount == 16 && theFormat->dwRGBAlphaBitMask == 0x0000 &&
        theFormat->dwRBitMask == 0xF800 && theFormat->dwGBitMask == 0x07E0 && theFormat->dwBBitMask == 0x001F) {
        return PixelFormat_R5G6B5;
    }

    if (theFormat->dwFlags == (DDPF_RGB | DDPF_PALETTEINDEXED8) && theFormat->dwRGBBitCount == 8) {
...
bool D3DInterface::InitD3D() {
    ...
    if (CheckDXError(
            mD3D->CreateDevice(IID_IDirect3DHALDevice, mDDSDrawSurface, &mD3DDevice),
    ...
    if (CheckDXError(mD3DDevice->GetCaps(&aCaps))) return false;
    ...
    if (gMaxTextureWidth > MAX_TEXTURE_SIZE) gMaxTextureWidth = MAX_TEXTURE_SIZE;
    if (gMaxTextureHeight > MAX_TEXTURE_SIZE) gMaxTextureHeight = MAX_TEXTURE_SIZE;

    if (gMinTextureWidth < 1) gMinTextureWidth = 1;
    if (gMinTextureHeight < 1) gMinTextureWidth = 1;

    if (gMaxTextureAspectRatio == 0) gMaxTextureAspectRatio = 65536;
...
bool D3DInterface::InitFromDDInterface(DDInterface *theInterface) {
    ...
    if (CheckDXError(
            theInterface->mDrawSurface->QueryInterface(IID_IDirectDrawSurface7, (LPVOID *)&mDDSDrawSurface),
            "Query DrawSurface"
        ))
        return false;
...
bool D3DInterface::PreDraw() {
    if (gSexyAppBase->mPhysMinimized) return false;

    if (!mSceneBegun) {
        HRESULT hr;

        if (!SUCCEEDED(mD3DDevice->SetRenderTarget(mDDSDrawSurface, 0)
            )) // this happens when there's been a mode switch (this caused the nvidia screensaver bluescreen)
        {
            gD3DInterfacePreDrawError = true;
            return false;
        } else gD3DInterfacePreDrawError = false;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static LPDIRECTDRAWSURFACE7 CreateTextureSurface(
    LPDIRECT3DDEVICE7 theDevice, LPDIRECTDRAW7 theDraw, int theWidth, int theHeight, PixelFormat theFormat
) {
    if (D3DInterface::CheckDXError(theDevice->SetTexture(0, NULL), "SetTexture NULL")) return NULL;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture8888(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight,
    bool rightPad
) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyTexture8888ToImage(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight
) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture4444(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight,
    bool rightPad
) {
    if (theImage->mColorTable == NULL) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyTexture4444ToImage(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight
) {
    char *srcRow = (char *)theDest;
    DWORD *dstRow = theImage->GetBits() + offy * theImage->GetWidth() + offx;
    ...
    for (int y = 0; y < theHeight; y++) {
        ...
        for (int x = 0; x < theWidth; x++) {
            ushort aPixel = *src++;
            *dst++ = 0xFF000000 | ((aPixel & 0xF000) << 16) | ((aPixel & 0x0F00) << 12) | ((aPixel & 0x00F0) << 8) |
                     ((aPixel & 0x000F) << 4);
        }
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture565(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight,
    bool rightPad
) {
    if (theImage->mColorTable == NULL) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyTexture565ToImage(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight
) {
    char *srcRow = (char *)theDest;
    DWORD *dstRow = theImage->GetBits() + offy * theImage->GetWidth() + offx;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexturePalette8(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight,
    bool rightPad
) {
    uchar *srcRow = (uchar *)theImage->mColorIndices + offy * theImage->GetWidth() + offx;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyTexturePalette8ToImage(
    void *theDest, DWORD theDestPitch, MemoryImage *theImage, int offx, int offy, int theWidth, int theHeight,
    LPDIRECTDRAWPALETTE thePalette
) {
    char *srcRow = (char *)theDest;
    DWORD *dstRow = theImage->GetBits() + offy * theImage->GetWidth() + offx;
...
static void CopyImageToTexture(
    LPDIRECTDRAWSURFACE7 theTexture, MemoryImage *theImage, int offx, int offy, int texWidth, int texHeight,
    ...
    DDSURFACEDESC2 aDesc;
    aDesc.dwSize = sizeof(aDesc);
    if (D3DInterface::CheckDXError(
            theTexture->Lock(NULL, &aDesc, DDLOCK_SURFACEMEMORYPTR | DDLOCK_WAIT | DDLOCK_WRITEONLY, NULL),
            "Lock Texture"
        ))
        return;
    ...
    if (aWidth > 0 && aHeight > 0) {
        switch (theFormat) {
        case PixelFormat_A8R8G8B8:
            CopyImageToTexture8888(aDesc.lpSurface, aDesc.lPitch, theImage, offx, offy, aWidth, aHeight, rightPad);
            break;
        case PixelFormat_A4R4G4B4:
            CopyImageToTexture4444(aDesc.lpSurface, aDesc.lPitch, theImage, offx, offy, aWidth, aHeight, rightPad);
            break;
        case PixelFormat_R5G6B5:
            CopyImageToTexture565(aDesc.lpSurface, aDesc.lPitch, theImage, offx, offy, aWidth, aHeight, rightPad);
            break;
        case PixelFormat_Palette8:
            CopyImageToTexturePalette8(aDesc.lpSurface, aDesc.lPitch, theImage, offx, offy, aWidth, aHeight, rightPad);
            break;
        }
...
static void GetBestTextureDimensions(int &theWidth, int &theHeight, bool isEdge, bool usePow2, DWORD theImageFlags) {
        ...
        for (i = 0; i < MAX_TEXTURE_SIZE; i++) {
            ...
            if ((aGoodValue - i) > 64) {
                ...
                while (true) {
                    ...
                    if (aLeftOver < 64 || IsPowerOf2(aLeftOver)) break;
    ...
    if (aWidth < gMinTextureWidth) aWidth = gMinTextureWidth;

    if (aHeight < gMinTextureHeight) aHeight = gMinTextureHeight;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
TextureData::~TextureData() { ReleaseTextures(); }
...
void TextureData::ReleaseTextures() {
    for (int i = 0; i < (int)mTextures.size(); i++) {
        ...
        if (aSurface != NULL) aSurface->Release();
    }
...
void TextureData::CreateTextureDimensions(MemoryImage *theImage) {
    ...
    if (aRightWidth > 0) GetBestTextureDimensions(aRightWidth, aRightHeight, true, usePow2, mImageFlags);
    else aRightWidth = mTexPieceWidth;

    // Calculate bottom boundary piece sizes
    int aBottomWidth = mTexPieceWidth;
    int aBottomHeight = aHeight % mTexPieceHeight;
    if (aBottomHeight > 0) GetBestTextureDimensions(aBottomWidth, aBottomHeight, true, usePow2, mImageFlags);
    else aBottomHeight = mTexPieceHeight;
...
void TextureData::CreateTextures(MemoryImage *theImage, LPDIRECT3DDEVICE7 theDevice, LPDIRECTDRAW7 theDraw) {
    ...
    if (!theImage->mHasAlpha && !theImage->mHasTrans && (gSupportedPixelFormats & PixelFormat_R5G6B5)) {
        if (!(theImage->mD3DFlags & D3DImageFlag_UseA8R8G8B8)) aFormat = PixelFormat_R5G6B5;
    }
    ...
    if (theImage->mColorIndices != NULL && (gSupportedPixelFormats & PixelFormat_Palette8)) {
        ...
        HRESULT aResult =
            theDraw->CreatePalette(DDPCAPS_8BIT | DDPCAPS_ALPHA | DDPCAPS_ALLOW256, aPalette, &aDDPalette, NULL);
        if (SUCCEEDED(aResult)) aFormat = PixelFormat_Palette8;
        else {
    ...
    if ((theImage->mD3DFlags & D3DImageFlag_UseA4R4G4B4) && aFormat == PixelFormat_A8R8G8B8 &&
    ...
    if (mWidth != theImage->mWidth || mHeight != theImage->mHeight || aFormat != mPixelFormat ||
    ...
    if (mPalette != NULL) mTexMemSize += 256 * 4;

    int aFormatSize = 4;
    if (aFormat == PixelFormat_Palette8) aFormatSize = 1;
    else if (aFormat == PixelFormat_R5G6B5) aFormatSize = 2;
    else if (aFormat == PixelFormat_A4R4G4B4) aFormatSize = 2;
    ...
    for (y = 0; y < aHeight; y += mTexPieceHeight) {
        for (x = 0; x < aWidth; x += mTexPieceWidth, i++) {
            ...
            if (createTextures) {
                ...
                if (mPalette != NULL) aPiece.mTexture->SetPalette(mPalette);
...
void TextureData::CheckCreateTextures(MemoryImage *theImage, LPDIRECT3DDEVICE7 theDevice, LPDIRECTDRAW7 theDraw) {
    if (mPixelFormat == PixelFormat_Unknown || theImage->mWidth != mWidth || theImage->mHeight != mHeight ||
        theImage->mBitsChangedCount != mBitsChangedCount || theImage->mD3DFlags != mImageFlags)
...
TextureData::GetTexture(int x, int y, int &width, int &height, float &u1, float &v1, float &u2, float &v2) {
    ...
    if (right > aPiece.mWidth) right = aPiece.mWidth;

    if (bottom > aPiece.mHeight) bottom = aPiece.mHeight;
...
///////////////////////////////////////////////////////////////////////////////
LPDIRECTDRAWSURFACE7
TextureData::GetTextureF(float x, float y, float &width, float &height, float &u1, float &v1, float &u2, float &v2) {
    int tx = x / mTexPieceWidth;
    int ty = y / mTexPieceHeight;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TextureData::Blt(
    LPDIRECT3DDEVICE7 theDevice, float theX, float theY, const Rect &theSrcRect, const Color &theColor
) {
    ...
    while (srcY < srcBottom) {
        ...
        while (srcX < srcRight) {
            ...
            D3DInterface::CheckDXError(
                theDevice->DrawPrimitive(D3DPT_TRIANGLESTRIP, gVertexType, aVertex, 4, 0), "DrawPrimitive (Tri) 1"
            );
...
struct VertexList {
    ...
    ~VertexList() {
        if (mVerts != mStackVerts) delete mVerts;
    }
    ...
    D3DTLVERTEX &operator[](int thePos) { return mVerts[thePos]; }
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
template <class Pred> struct PointClipper {
    Pred mPred;
...
///////////////////////////////////////////////////////////////////////////////
template <class Pred>
void PointClipper<Pred>::ClipPoint(
    int n, float clipVal, const D3DTLVERTEX &v1, const D3DTLVERTEX &v2, VertexList &out
) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
template <class Pred> void PointClipper<Pred>::ClipPoints(int n, float clipVal, VertexList &in, VertexList &out) {
    if (in.size() < 2) return;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TextureData::BltTransformed(
    LPDIRECT3DDEVICE7 theDevice, const SexyMatrix3 &theTrans, const Rect &theSrcRect, const Color &theColor,
    ...
    while (srcY < srcBottom) {
        ...
        while (srcX < srcRight) {
            ...
            SexyVector2 p[4] = {
                SexyVector2(x, y), SexyVector2(x, y + aHeight), SexyVector2(x + aWidth, y),
            ...
            if (!clipped)
                D3DInterface::CheckDXError(
                    theDevice->DrawPrimitive(D3DPT_TRIANGLESTRIP, gVertexType, aVertex, 4, 0), "DrawPrimitive (Tri) 3"
                );
            else {
                VertexList aList;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TextureData::BltTriangles(
    LPDIRECT3DDEVICE7 theDevice, const TriVertex theVertices[][3], int theNumTriangles, DWORD theColor, float tx,
    float ty
) {
    if ((mMaxTotalU <= 1.0) && (mMaxTotalV <= 1.0)) {
        ...
        for (int aTriangleNum = 0; aTriangleNum < theNumTriangles; aTriangleNum++) {
            ...
            if ((aVertexCacheNum == 100) || (aTriangleNum == theNumTriangles - 1)) {
                ...
                D3DInterface::CheckDXError(
                    theDevice->DrawPrimitive(D3DPT_TRIANGLELIST, gVertexType, aVertexCache, aVertexCacheNum * 3, 0),
                    "DrawPrimitive (TriList)"
                );
                aVertexCacheNum = 0;
            }
        }
        ...
        for (int aTriangleNum = 0; aTriangleNum < theNumTriangles; aTriangleNum++) {
            ...
            D3DTLVERTEX aVertex[3] = {
                {aTriVerts[0].x + tx, aTriVerts[0].y + ty, 0, 1, GetColorFromTriVertex(aTriVerts[0], theColor), 0,
                 aTriVerts[0].u * mMaxTotalU, aTriVerts[0].v * mMaxTotalV},
                {aTriVerts[1].x + tx, aTriVerts[1].y + ty, 0, 1, GetColorFromTriVertex(aTriVerts[1], theColor), 0,
                 aTriVerts[1].u * mMaxTotalU, aTriVerts[1].v * mMaxTotalV},
                {aTriVerts[2].x + tx, aTriVerts[2].y + ty, 0, 1, GetColorFromTriVertex(aTriVerts[2], theColor), 0,
                 aTriVerts[2].u * mMaxTotalU, aTriVerts[2].v * mMaxTotalV}
            };
            ...
            int i, j, k;
            for (i = 0; i < 3; i++) {
                if (aVertex[i].tu < aMinU) aMinU = aVertex[i].tu;

                if (aVertex[i].tv < aMinV) aMinV = aVertex[i].tv;

                if (aVertex[i].tu > aMaxU) aMaxU = aVertex[i].tu;

                if (aVertex[i].tv > aMaxV) aMaxV = aVertex[i].tv;
            }
            ...
            if (aLeft < 0) aLeft = 0;
            if (aTop < 0) aTop = 0;
            if (aRight > mTexVecWidth) aRight = mTexVecWidth;
            if (aBottom > mTexVecHeight) aBottom = mTexVecHeight;
            ...
            for (i = aTop; i < aBottom; i++) {
                for (j = aLeft; j < aRight; j++) {
                    ...
                    for (k = 0; k < 3; k++) {
                        aList[k].tu -= j;
                        aList[k].tv -= i;
                        if (i == mTexVecHeight - 1) aList[k].tv *= (float)aStandardPiece.mHeight / aPiece.mHeight;
                        if (j == mTexVecWidth - 1) aList[k].tu *= (float)aStandardPiece.mWidth / aPiece.mWidth;
                    }
                    ...
                    if (aList.size() >= 3) {
                        ...
                        /*				CheckDXError(theDevice->SetTexture(0, NULL),"SetTexture NULL");
                                        ...
                                        CheckDXError(theDevice->DrawPrimitive(D3DPT_TRIANGLEFAN, gVertexType, &aList[0],
                           aList.size(), D3DDP_WAIT),"DrawPrimitive (Tri)");
...
bool D3DInterface::CreateImageTexture(MemoryImage *theImage) {
    ...
    if (wantPurge) theImage->PurgeBits();
...
bool D3DInterface::RecoverBits(MemoryImage *theImage) {
    if (theImage->mD3DData == NULL) return false;
    ...
    for (int aPieceRow = 0; aPieceRow < aData->mTexVecHeight; aPieceRow++) {
        for (int aPieceCol = 0; aPieceCol < aData->mTexVecWidth; aPieceCol++) {
            ...
            aDesc.dwSize = sizeof(aDesc);
            if (D3DInterface::CheckDXError(
                    aPiece->mTexture->Lock(NULL, &aDesc, DDLOCK_SURFACEMEMORYPTR | DDLOCK_WAIT | DDLOCK_READONLY, NULL),
                    "Lock Texture"
                ))
                return false;
            ...
            case PixelFormat_A8R8G8B8:
                CopyTexture8888ToImage(aDesc.lpSurface, aDesc.lPitch, theImage, offx, offy, aWidth, aHeight);
                break;
            case PixelFormat_A4R4G4B4:
            ...
            case PixelFormat_R5G6B5:
                ...
                break;
            case PixelFormat_Palette8:
                CopyTexturePalette8ToImage(
                    aDesc.lpSurface, aDesc.lPitch, theImage, offx, offy, aWidth, aHeight, aData->mPalette
                );
                break;
            }
...
void D3DInterface::SetCurTexture(MemoryImage *theImage) {
    ...
    if (!CreateImageTexture(theImage)) return;
...
void D3DInterface::PushTransform(const SexyMatrix3 &theTransform, bool concatenate) {
    if (mTransformStack.empty() || !concatenate) mTransformStack.push_back(theTransform);
    else {
...
void D3DInterface::PopTransform() {
    if (!mTransformStack.empty()) mTransformStack.pop_back();
}
        ...
        /*		if (theImage != NULL)
                {
                    ...
                    mD3DDevice->SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, (anImage->mHasAlpha ||
           anImage->mHasTrans || theColor.mAlpha<255)?TRUE:FALSE);
                }
                else
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::Blt(
    Image *theImage, float theX, float theY, const Rect &theSrcRect, const Color &theColor, int theDrawMode,
    bool linearFilter
) {
...
void D3DInterface::StretchBlt(
    ...
    } else aTransform.Scale(xScale, yScale);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::BltRotated(
    Image *theImage, float theX, float theY, const Rect *theClipRect, const Color &theColor, int theDrawMode,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::BltTransformed(
    Image *theImage, const Rect *theClipRect, const Color &theColor, int theDrawMode, const Rect &theSrcRect,
    ...
    if (!mTransformStack.empty()) {
        ...
        if (theX != 0 || theY != 0) {
            SexyTransform2D aTransform;
            if (center) aTransform.Translate(-theSrcRect.mWidth / 2.0f, -theSrcRect.mHeight / 2.0f);
...
void D3DInterface::DrawLine(
    ...
    D3DInterface::CheckDXError(
        mD3DDevice->DrawPrimitive(D3DPT_LINESTRIP, gVertexType, aVertex, 3, 0), "DrawPrimitive (Line)"
    );
}
...
void D3DInterface::FillPoly(
    ...
    if (theClipRect != NULL) DrawPolyClipped(mD3DDevice, theClipRect, aList);
    else
        D3DInterface::CheckDXError(
            mD3DDevice->DrawPrimitive(D3DPT_TRIANGLEFAN, gVertexType, &aList[0], aList.size(), 0),
            "DrawPrimitive (FillPoly)"
        );
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::DrawTriangleTex(
    const TriVertex &p1, const TriVertex &p2, const TriVertex &p3, const Color &theColor, int theDrawMode,
    Image *theTexture, bool blend
) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::DrawTrianglesTex(
    const TriVertex theVertices[][3], int theNumTriangles, const Color &theColor, int theDrawMode, Image *theTexture,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::DrawTrianglesTexStrip(
    const TriVertex theVertices[], int theNumTriangles, const Color &theColor, int theDrawMode, Image *theTexture,
    float tx, float ty, bool blend
) {
