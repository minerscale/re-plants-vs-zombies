...
void VkImage::
    ...
    VkOffset3D srcOffsets[2] = {
        {theSrcRect.mX,     theSrcRect.mY,      0},
        {theSrcRect.mWidth, theSrcRect.mHeight, 1}
    };
    ...
    vkCmdBlitImage(
        commandBuffer, vkImage->image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, image,
        VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &pRegions, VK_FILTER_NEAREST
    );
