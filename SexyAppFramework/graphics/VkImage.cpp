...
void VkImage::FillRect(const Rect &theRect, const Color &theColor, int theDrawMode) {
    ...
    glm::vec4 theClipRect = {0, 0, theRect.mWidth, theRect.mHeight};
...
void VkImage::Blt(Image *theImage, int theX, int theY, const Rect &theSrcRect, const Color &theColor, int theDrawMode) {
    glm::mat3 theMatrix =
        glm::translate(glm::mat3(1.0), glm::vec2(theX + theSrcRect.mWidth / 2.0, theY + theSrcRect.mHeight / 2.0));
...
void VkImage::BeginDraw(Image *theImage, int theDrawMode) {
    ...
    if (drawModeMiss) {
        ...
        else vkCmdBindPipeline(imageCommandBuffers[imageBufferIdx], VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
    }
...
void VkImage::BltEx(
    ...
    ImagePushConstants constants = {
        ...
        {0,           0,           0,           0          },
        colorToVec4(theColor), true, blend
    };
...
void VkImage::StretchBlt(
    ...
    glm::mat3 theMatrix = glm::scale(
        glm::translate(
            glm::mat3(1.0),
            glm::vec2(theDestRect.mX + theSrcRect.mWidth / 2.0, theDestRect.mY + theSrcRect.mHeight / 2.0)
        ),
