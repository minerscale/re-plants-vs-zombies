...
void DialogButton::Draw(Graphics *g) {
    ...
    if (mNormalRect.mWidth == 0) {
        ...
        else if (IsButtonDown()) g->DrawImageBox(mDownRect, Rect(0, 0, mWidth, mHeight), mComponentImage);
        ...
        else g->DrawImageBox(mNormalRect, Rect(0, 0, mWidth, mHeight), mComponentImage);
