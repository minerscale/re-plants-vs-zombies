...
void TitleScreen::DrawToPreload(Graphics *g) { g->DrawImageF(IMAGE_PLANTSHADOW, 1000.0f, 0.0f); }
...
void TitleScreen::ButtonDepress(int theId) {
    ...
    case TitleScreen::TitleScreen_Register: mRegisterClicked = true; break;
    }
}
