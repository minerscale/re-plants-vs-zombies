...
int LawnDialog::GetLeft() { return mContentInsets.mLeft + mBackgroundInsets.mLeft; }
...
// 0x4572E0
void LawnDialog::ButtonPress(int theId) { mApp->PlaySample(Sexy::SOUND_GRAVEBUTTON); }
...
// 0x457320
void LawnDialog::CheckboxChecked(int theId, bool theChecked) { mApp->PlaySample(Sexy::SOUND_BUTTONCLICK); }
